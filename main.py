...
power_button = machine.Pin(9, mode=machine.Pin.OUT, pull=None, value=0)
pause_button = machine.Pin(11, mode=machine.Pin.OUT, pull=None, value=0)
up_button = machine.Pin(14, mode=machine.Pin.OUT, pull=None, value=0)
down_button = machine.Pin(15, mode=machine.Pin.OUT, pull=None, value=0)
## ADC Setup
...
# Timers
button_press_timer = machine.Timer()
logging_timer = machine.Timer()
log_retry_timer = machine.Timer()
# WLAN Setup
...
def button_delay(): #Call this after a button press
    button_press_timer.init(mode=machine.Timer.ONE_SHOT,period=600_000,callback=all_buttons_off) # 
